...
function SetUpRotation (centerPos : Vector3, headPos : Vector3)
{
	...
	var centerRay = cameraTransform.GetComponent.<UnityEngine.Camera>().ViewportPointToRay(Vector3(.5, 0.5, 1));
	var topRay = cameraTransform.GetComponent.<UnityEngine.Camera>().ViewportPointToRay(Vector3(.5, clampHeadPositionScreenSpace, 1));
